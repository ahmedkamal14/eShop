...
import { fetchAllProducts } from "@/Store/Slices/productsSlice"; // Import the fetch action
...
const NewArrivals = () => {
  ...
  const newArrivals = products.slice(175, 181); // Modify this according to your logic for new arrivals

  return (
    <div className="py-6 px-6">
      <div className="container max-w-[1750px] m-auto py-[72px] flex flex-col gap-[55px] border-b items-center">
        <h2 className="text-[48px] font-bold text-center">New Arrivals</h2>
